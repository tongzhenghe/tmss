...
<body>
<div id="admin_header">
  <div id="admin_logo"><img src="__ASSETS__/images/topLogo.gif" /></div>
  <div id="submenu-div">
    <ul>
...
<div id="admin_bottom" style="text-align:center; line-height:30px">Copyright &copy; <?php echo date('Y');?> 汤姆叔叔</div>
