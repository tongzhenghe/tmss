...
?>
    <tr>
      ...
      <td align="center">
        <a href="favourable.php?act=edit&amp;id=<?php echo $this->_var['favourable']['act_id']; ?>" title="<?php echo $this->_var['lang']['edit']; ?>"><img src="images/icon_edit.gif" border="0" height="21" width="21" /></a>
        <a href="javascript:;" onclick="listTable.remove(<?php echo $this->_var['favourable']['act_id']; ?>,'<?php echo $this->_var['lang']['drop_confirm']; ?>')" title="<?php echo $this->_var['lang']['remove']; ?>"><img src="images/icon_drop.gif" border="0" height="21" width="21" /></a>      </td>
    </tr>
    <?php endforeach; else: ?>
