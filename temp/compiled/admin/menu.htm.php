...
.ico_1{background:#1480b3 url(images/menu_1.png) 9px 0 no-repeat ;}
.ico_2{background:#1480b3 url(images/menu_2.png) 9px 0 no-repeat ;}
.ico_3{background:#1480b3 url(images/menu_3.png) 9px 0 no-repeat ;}
.ico_4{background:#1480b3 url(images/menu_4.png) 9px 0 no-repeat ;}
.ico_5{background:#1480b3 url(images/menu_5.png) 9px 0 no-repeat ;}
.ico_6{background:#1480b3 url(images/menu_6.png) 9px 0 no-repeat ;}
.ico_7{background:#1480b3 url(images/menu_7.png) 9px 0 no-repeat ;}
.ico_8{background:#1480b3 url(images/menu_8.png) 9px 0 no-repeat ;}
.ico_9{background:#1480b3 url(images/menu_9.png) 9px 0 no-repeat ;}
.ico_10{background:#1480b3 url(images/menu_10.png) 9px 0 no-repeat ;}
.ico_11{background:#1480b3 url(images/menu_11.png) 9px 0 no-repeat ;}
.ico_12{background:#1480b3 url(images/menu_12.png) 9px 0 no-repeat ;}
.ico_13{background:#1480b3 url(images/menu_13.png) 9px 0 no-repeat ;}
.ico_14{background:#1480b3 url(images/menu_14.png) 9px 0 no-repeat ;}
.ico_15{background:#1480b3 url(images/menu_15.png) 9px 0 no-repeat ;}
.ico_16{background:#1480b3 url(images/menu_16.png) 9px 0 no-repeat ;}
