...
?>
    <tr>
      ...
      <td align="center">
        <a href="order.php?act=list&amp;group_buy_id=<?php echo $this->_var['group_buy']['act_id']; ?>"><img src="images/icon_view.gif" title="<?php echo $this->_var['lang']['view_order']; ?>" border="0" height="21" width="21" /></a>
        <a href="group_buy.php?act=edit&amp;id=<?php echo $this->_var['group_buy']['act_id']; ?>" title="<?php echo $this->_var['lang']['edit']; ?>"><img src="images/icon_edit.gif" border="0" height="21" width="21" /></a>
        <a href="javascript:;" onclick="listTable.remove(<?php echo $this->_var['group_buy']['act_id']; ?>,'<?php echo $this->_var['lang']['drop_confirm']; ?>')" title="<?php echo $this->_var['lang']['remove']; ?>"><img src="images/icon_drop.gif" border="0" height="21" width="21" /></a>
      </td>
    </tr>
    <?php endforeach; else: ?>
