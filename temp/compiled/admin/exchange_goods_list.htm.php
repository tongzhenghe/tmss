...
?>
  <tr>
    ...
    <td align="center" nowrap="true"><span>
      <a href="../exchange.php?id=<?php echo $this->_var['list']['goods_id']; ?>&act=view" target="_blank" title="<?php echo $this->_var['lang']['view']; ?>"><img src="images/icon_view.gif" border="0" height="21" width="21" /></a>&nbsp;
      <a href="exchange_goods.php?act=edit&id=<?php echo $this->_var['list']['goods_id']; ?>" title="<?php echo $this->_var['lang']['edit']; ?>"><img src="images/icon_edit.gif" border="0" height="21" width="21" /></a>&nbsp;
      <a href="javascript:;" onclick="listTable.remove(<?php echo $this->_var['list']['goods_id']; ?>, '<?php echo $this->_var['lang']['drop_confirm']; ?>')" title="<?php echo $this->_var['lang']['remove']; ?>"><img src="images/icon_drop.gif" border="0" height="21" width="21"></a></span>
    </td>
   </tr>
   <?php endforeach; else: ?>
