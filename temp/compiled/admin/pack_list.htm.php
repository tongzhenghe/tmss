...
?>
    <tr>
      <td class="first-cell">
        <?php if (( $this->_var['pack']['pack_img'] )): ?><a href = "../data/packimg/<?php echo $this->_var['pack']['pack_img']; ?>" target="_brank"><img src="images/picflag.gif" width="16" height="16" border="0" alt="" /></a><?php else: ?><img src="images/picnoflag.gif" width="21" height="21" border="0" alt="" /><?php endif; ?>
      ...
      <td align="center" nowrap="true" valign="top">
        <a href="?act=edit&amp;id=<?php echo $this->_var['pack']['pack_id']; ?>" title="<?php echo $this->_var['lang']['edit']; ?>"><img src="images/icon_edit.gif" border="0" height="21" width="21"></a>
        <a href="javascript:;" onclick="listTable.remove(<?php echo $this->_var['pack']['pack_id']; ?>, '<?php echo $this->_var['lang']['drop_confirm']; ?>')" title="<?php echo $this->_var['lang']['remove']; ?>"><img src="images/icon_drop.gif" border="0" height="21" width="21"></a>
      </td>
    </tr>
    <?php endforeach; else: ?>
