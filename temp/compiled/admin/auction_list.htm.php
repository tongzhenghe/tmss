...
?>
    <tr>
      ...
      <td align="center">
        <a href="auction.php?act=view_log&id=<?php echo $this->_var['auction']['act_id']; ?>"><img src="images/icon_view.gif" title="<?php echo $this->_var['lang']['auction_log']; ?>" border="0" height="21" width="21" /></a>
        <a href="auction.php?act=edit&amp;id=<?php echo $this->_var['auction']['act_id']; ?>" title="<?php echo $this->_var['lang']['edit']; ?>"><img src="images/icon_edit.gif" border="0" height="21" width="21" /></a>
        <a href="javascript:;" onclick="listTable.remove(<?php echo $this->_var['auction']['act_id']; ?>,'<?php echo $this->_var['lang']['drop_confirm']; ?>')" title="<?php echo $this->_var['lang']['remove']; ?>"><img src="images/icon_drop.gif" border="0" height="21" width="21" /></a>      </td>
    </tr>
    <?php endforeach; else: ?>
