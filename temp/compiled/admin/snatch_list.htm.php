...
?>
    <tr>
      ...
      <td align="center">
        <a href="snatch.php?act=view&amp;snatch_id=<?php echo $this->_var['snatch']['act_id']; ?>" title="<?php echo $this->_var['lang']['view_detail']; ?>"><img src="images/icon_view.gif" border="0" height="21" width="21"></a>
        <a href="snatch.php?act=edit&amp;id=<?php echo $this->_var['snatch']['act_id']; ?>" title="<?php echo $this->_var['lang']['edit']; ?>"><img src="images/icon_edit.gif" border="0" height="21" width="21"></a>
        <a href="javascript:;" onclick="listTable.remove(<?php echo $this->_var['snatch']['act_id']; ?>,'<?php echo $this->_var['lang']['drop_confirm']; ?>')" title="<?php echo $this->_var['lang']['remove']; ?>"><img src="images/icon_drop.gif" border="0" height="21" width="21"></a>
      </td>
    </tr>
    <?php endforeach; else: ?>
