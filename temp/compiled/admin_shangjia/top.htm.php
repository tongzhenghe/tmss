...
<body>
<div id="header-div">
  <div id="logo-div" style="bgcolor:#000000;"><img src="images/topLogo.gif" alt="汤姆叔叔" /></div>
  ...
  <div id="submenu-div">
    ...
    <li><a href="privilege.php?act=logout" target="main-frame"><img src="images/topmune_08.png" style="border:none;"/><span><?php echo $this->_var['lang']['signout']; ?></span></a></li>
     <li><a href="index.php?act=clear_cache" target="main-frame" class="fix-submenu"><img src="images/qingchu.png" style="border:none;"/><span><?php echo $this->_var['lang']['clear_cache']; ?></span></a></li>
      ...
      <li><a href="../seller_store.php?sid=<?php echo $this->_var['store_id']; ?>" target="_blank"><img src="images/topmune_06.png" style="border:none;"/><span><?php echo $this->_var['lang']['preview']; ?></span></a></li>
...
<div id="menu-div">
  <ul>
    ...
    <li><a href="goods.php?act=list" target="main-frame"><img src="images/index-11_09.png" width="17" height="18" align="absmiddle"/><span>商品管理</span></a><span class="muneFG"></span></li>
     <li><a href="order.php?act=list" target="main-frame"><img src="images/dd.png" width="15" height="18" align="absmiddle"/><span>订单管理</span></a><span class="muneFG"></span></li>
     <li><a href="comment_manage.php?act=list" target="main-frame"><img src="images/index-11_19.png" width="17" height="18" align="absmiddle"/><span>用户评论</span></a><span class="muneFG"></span></li>
     <li><a href="seller_shop_slide.php?act=list" target="main-frame"><img src="images/index-11_19.png" width="17" height="18" align="absmiddle"/><span>店铺幻灯片</span></a><span class="muneFG"></span></li>
     <li><a href="index.php?act=shop_top" target="main-frame"><img src="images/index-11_19.png" width="17" height="18" align="absmiddle"/><span>店铺头部装修</span></a><span class="muneFG"></span></li>
     <li><a href="seller_window.php?act=list" target="main-frame"><img src="images/index-11_19.png" width="17" height="18" align="absmiddle"/><span>店铺橱窗设置</span></a><span class="muneFG"></span></li>
     <li><a href="seller_template.php?act=list" target="main-frame"><img src="images/index-11_19.png" width="17" height="18" align="absmiddle"/><span>店铺模板选择</span></a><span class="muneFG"></span></li>
