...
<div id="nav">
	<div class="w">
    	<div class="logo"><a href="./index.php" hidefocus="true" ><b></b><img src="themes/jingdong2015/images/logo.gif" width="270" height="48" alt="汤姆"></a></div>
        <div class="navitems">
        	<ul>
            	<li class="fore"><a href="./index.php">首页</a></li>
                <li class="fore"><a href="">个人主页</a></li>
                <li class="fore1">
                	<div class="dt"><span class="myjd-set">账户设置</span><b><i></i></b></div>
                    <div class="dd">
                    	<a href="user.php?act=profile"><?php echo $this->_var['lang']['label_profile']; ?></a>
                        <a href="user.php?act=address_list"><?php echo $this->_var['lang']['label_address']; ?></a>
                        <a href="user.php?act=bonus"><?php echo $this->_var['lang']['label_bonus']; ?></a>
                        <a href="user.php?act=account_log"><?php echo $this->_var['lang']['label_user_surplus']; ?></a>
                    </div>
                </li>
            </ul>
        </div>
...
<div class="lyt-c-0">
	<div class="user-info">
    	<div class="info-lcol">
        	<div class="u-pic"><img src="themes/jingdong2015/images/no-img_mid_.jpg" alt="用户头像" /><i></i></div>
            <div class="info-m">
            	<div class="u-name"><?php echo $this->_var['info']['username']; ?></div>
                <div class="u-level"><?php echo $this->_var['rank_name']; ?>，<?php echo $this->_var['next_rank_name']; ?></div>
                <div class="u-safe"><?php if ($this->_var['info']['is_validate'] == 0): ?><?php echo $this->_var['lang']['not_validated']; ?><br /><a href="javascript:sendHashMail()" style="color:#006bd0;"><?php echo $this->_var['lang']['resend_hash_mail']; ?></a><?php endif; ?></div>
                <div class="info-line">
        ...
        <div class="info-rcol">
        	<div class="acco-info">
            	<div class="acco-item">
                	<p><?php echo $this->_var['lang']['your_surplus']; ?>：	<a href="user.php?act=account_log" style="color:#006bd0;"><?php echo $this->_var['info']['surplus']; ?></a></p>
                    <?php if ($this->_var['info']['credit_line'] > 0): ?>
                    <p><?php echo $this->_var['lang']['credit_line']; ?>：<?php echo $this->_var['info']['formated_credit_line']; ?></p>
                    <?php endif; ?>
                    <p><?php echo $this->_var['lang']['your_bonus']; ?>：<a href="user.php?act=bonus" style="color:#006bd0;"><?php echo $this->_var['info']['bonus']; ?></a></p>
                    <p><?php echo $this->_var['lang']['your_integral']; ?>：<?php echo $this->_var['info']['integral']; ?></p>
                    <p><?php echo $this->_var['lang']['last_month_order']; ?><?php echo $this->_var['info']['order_count']; ?><?php echo $this->_var['lang']['order_unit']; ?></p>
                </div>
            </div>
        </div>
    </div>
</div>
<div class="lyt-c-1"><img src="themes/jingdong2015/images/note.gif" alt="note" />&nbsp;&nbsp;<?php echo $this->_var['user_notice']; ?></div>
<div class="lyt-c-2"><?php echo $this->fetch('library/history_user.lbi'); ?></div>
<?php endif; ?>
...
<h5 class="mc"><span><?php echo $this->_var['lang']['label_message']; ?></span></h5>
...
<td>
<a href ="<?php echo $this->_var['order_info']['url']; ?>"><img src="themes/jingdong2015/images/note.gif" /><?php echo $this->_var['order_info']['order_sn']; ?></a>
...
<div class="boxCenterList">
<h5 class="mc"><span><?php echo $this->_var['lang']['label_comment']; ?></span></h5>
...
<div class="boxCenterList">
<h5 class="mc"><span><?php echo $this->_var['lang']['label_tag']; ?></span></h5>
...
?>
<a href="search.php?keywords=<?php echo urlencode($this->_var['tag']['tag_words']); ?>" class="f6"><?php echo htmlspecialchars($this->_var['tag']['tag_words']); ?></a> <a href="user.php?act=act_del_tag&amp;tag_words=<?php echo urlencode($this->_var['tag']['tag_words']); ?>" onclick="if (!confirm('<?php echo $this->_var['lang']['confirm_drop_tag']; ?>')) return false;" title="<?php echo $this->_var['lang']['drop']; ?>"><img src="themes/jingdong2015/images/drop.gif" alt="<?php echo $this->_var['lang']['drop']; ?>" /></a>&nbsp;&nbsp;
<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
<?php else: ?>
...
<div class="boxCenterList">
<h5 class="mc"><span><?php echo $this->_var['lang']['label_collection']; ?></span></h5>
...
<div class="boxCenterList">
<h5 class="mc"><span><?php echo $this->_var['lang']['label_affiliate']; ?></span></h5>
...
<div class="boxCenterList">
<h5 class="mc"><span><?php echo $this->_var['lang']['label_booking']; ?></span></h5>
<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
<tr align="center">
...
<div class="boxCenterList">
<h5 class="mc"><span><?php echo $this->_var['lang']['affiliate_detail']; ?></span></h5>
<div style="border-top:1px solid #ccc; padding-top:10px;"><?php echo $this->_var['affiliate_intro']; ?></div>
</div>
<?php if ($this->_var['affiliate']['config']['separate_by'] == 0): ?>

<div class="boxCenterList">
<h5 class="mc"><span><a name="myrecommend"><?php echo $this->_var['lang']['affiliate_member']; ?></a></span></h5>
<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
<tr align="center">
...
<div class="boxCenterList">
<h5 class="mc"><span><?php echo $this->_var['lang']['affiliate_code']; ?></span></h5>
<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
<tr>
...
<?php endif; ?>
	...
	<div class="left">
		<div id="myjd" class="m">
        	<div class="mt"><h2><a href="user.php">我的汤姆</a></h2></div>
