...
?>
          <tr class="order_info">
          	<td colspan="7">
            	<span><?php echo $this->_var['lang']['order_number']; ?>:<a href="user.php?act=order_detail&order_id=<?php echo $this->_var['item']['order_id']; ?>" class="f6"><?php echo $this->_var['item']['order_sn']; ?></a></span>
                <span>商家店铺：<?php if ($this->_var['item']['store']): ?><a href="seller_store.php?sid=<?php echo $this->_var['item']['store']['id']; ?>" target="_blank"><?php echo $this->_var['item']['store']['shop_name']; ?></a><?php else: ?>网站自营<?php endif; ?></span>
                <span>提交时间：<?php echo $this->_var['item']['order_time']; ?></span>
            </td>
          </tr>
          <tr class="order_item">
          	<td width="240" align="left">
            <?php $_from = $this->_var['item']['goods_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods');if (count($_from)):
    foreach ($_from AS $this->_var['goods']):
?>
            	<div class="order_goods">
                	<a href="goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank" class="order_goods_img"><img src="<?php echo $this->_var['goods']['goods_thumb']; ?>" class="order_goods_item" /></a>
    ...
    foreach ($_from AS $this->_var['goods']):
?>
            	<div class="order_num_price"><?php echo $this->_var['goods']['goods_price']; ?></div>
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
            </td>
            <td width="80">
            <?php $_from = $this->_var['item']['goods_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods');if (count($_from)):
    foreach ($_from AS $this->_var['goods']):
?>
            	<div class="order_number"><?php echo $this->_var['goods']['goods_number']; ?></div>
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
            </td>
            <td width="80"><div class="u_name"><?php echo $this->_var['item']['consignee']; ?></div></td>
            <td width="90" class="price"><div class="u_price"><?php echo $this->_var['item']['total_fee']; ?></div></td>
            <td width="100"><div class="u_status"><?php echo $this->_var['item']['order_status']; ?></div></td>
            <td width="110"><div class="u_handler"><?php echo $this->_var['item']['handler']; ?></div></td>
          </tr>
          <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
       </table>
    <div class="blank10"></div>
